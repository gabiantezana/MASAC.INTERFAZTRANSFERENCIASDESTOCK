...
namespace SAPWT.MODEL
{
    ...
    public partial class WTR1
    {
        ...
        public string U_STR_Imp { get; set; }
        public Nullable<decimal> U_BPP_PcAr { get; set; }
        public string U_BPP_OPER { get; set; }
        public Nullable<decimal> U_CE_IMSL { get; set; }
        public string U_STR_MOTIVO { get; set; }
        public string U_TIENDA { get; set; }
        public string U_motivo_merma { get; set; }
    }
}
