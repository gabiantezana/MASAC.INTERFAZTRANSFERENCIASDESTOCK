...
namespace SAPWT.MODEL
{
    ...
    public partial class OWTR
    {
        ...
        public string U_OUT_MNTO { get; set; }
        public string U_BPP_MDMT { get; set; }
        public string U_BPP_CDAD { get; set; }
        public string U_BPP_MDCT { get; set; }
        public string U_BPP_AstDetrac { get; set; }
        public string U_BPP_CdBn { get; set; }
        public string U_BPP_CdOp { get; set; }
        public string U_OUT_TPTRSC { get; set; }
        public string U_BPP_AsPc { get; set; }
        public Nullable<decimal> U_BPP_TtPc { get; set; }
        ...
        public string U_BPP_SND { get; set; }
        public Nullable<System.DateTime> U_BPP_SDocDate { get; set; }
        public string U_BPP_MDND { get; set; }
        public Nullable<System.DateTime> U_STR_FECDETR { get; set; }
        public string U_CE_EAR { get; set; }
        public string U_CE_DCCE { get; set; }
        public string U_CE_TPRN { get; set; }
        public string U_CE_MNDA { get; set; }
        public string U_BPP_OPER { get; set; }
        public string U_OC { get; set; }
        public string U_guias { get; set; }
        public string U_MSS_TIDA { get; set; }
        public string U_MSS_TVTA { get; set; }
        public string U_MSS_CITR { get; set; }
        public string U_MSS_ESTA { get; set; }
        public string U_MSS_ERROR { get; set; }
    }
}
